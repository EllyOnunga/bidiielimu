...
class StudentType(DjangoObjectType):
    class Meta:
        model = Student
        fields = ('id', 'admission_number', 'first_name', 'last_name', 'stream', 'marks')
...
class ExamType(DjangoObjectType):
    class Meta:
        model = Exam
        fields = ('id', 'name', 'term', 'academic_year', 'start_date', 'end_date', 'marks')
...
class CreateMark(graphene.Mutation):
    ...
    @classmethod
    def mutate(cls, root, info, exam_id, student_id, subject_id, score, teacher_remarks=None):
        user = info.context.user
        ...
        try:
            ...
            student = Student.objects.get(id=student_id, stream__grade_level__school=user.school)
