...
class GradeThreshold(models.Model):
    grading_system = models.ForeignKey(
        GradingSystem, on_delete=models.CASCADE, related_name="thresholds"
    )
...
class ExamRanking(models.Model):
    student = models.ForeignKey(
        "students.Student", on_delete=models.CASCADE, related_name="rankings"
    )
...
class CBCAssessment(models.Model):
    ...
    student = models.ForeignKey(
        "students.Student", on_delete=models.CASCADE, related_name="cbc_assessments"
    )
    sub_strand = models.ForeignKey(
        "classes.SubStrand", on_delete=models.CASCADE, related_name="assessments"
    )
