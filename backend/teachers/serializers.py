...
class TeacherSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'last_name', 'name', 'full_name', 'phone_number', 'designation', 'specialization', 
    ...
    def create(self, validated_data):
        ...
        try:
            user = User.objects.create_user(
                email=email, password=password, role=role_obj,
        ...
        try:
            ...
            EmailService.send_welcome_email(user, login_url=login_url, plain_password=password)
