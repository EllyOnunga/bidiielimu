...
class Teacher(SoftDeleteModel):
    ...
    contract_type = models.CharField(
        max_length=20, choices=CONTRACT_CHOICES, default="PERMANENT"
    )
...
class HRSettings(models.Model):
    ...
    shif_rate = models.DecimalField(
        max_digits=5, decimal_places=4, default=0.0275
    )  # 2.75%
    housing_levy_rate = models.DecimalField(
        max_digits=5, decimal_places=4, default=0.015
    )  # 1.5%
    nssf_tier_1_max = models.DecimalField(
        max_digits=10, decimal_places=2, default=7000.00
    )
    nssf_tier_2_max = models.DecimalField(
        max_digits=10, decimal_places=2, default=36000.00
    )
