...
urlpatterns = [
    ...
    path(
        "subject-dist/<int:subject_id>/<int:exam_id>/",
        SubjectDistributionView.as_view(),
        name="subject-dist",
    ),
    path(
        "teacher-eval/<int:teacher_id>/",
        TeacherPerformanceView.as_view(),
        name="teacher-eval",
    ),
    path(
        "correlation/",
        CorrelationAnalyticsView.as_view(),
        name="attendance-correlation",
    ),
]
