...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'text_content', 'file', 'submitted_at', 'grade', 'feedback', 
            'is_graded', 'max_score'
        ]
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'stream', 'stream_name', 'teacher', 'teacher_name', 
            'due_date', 'max_score', 'file', 'submission_count', 'status', 
            'student_grade', 'student_feedback', 'created_at'
        ]
    ...
    def get_student_grade(self, obj):
        try:
            ...
            if request and request.user.is_authenticated and request.user.role_name == 'STUDENT':
...
class QuizSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Quiz
        fields = ['id', 'subject', 'title', 'description', 'duration_minutes', 'is_active', 'questions', 'question_count']
