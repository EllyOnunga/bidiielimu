    ...
    <div className="space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          >
            <div
              className={`w-14 h-14 rounded-2xl ${kpi.bg} flex items-center justify-center ${kpi.color}`}
            >
      ...
      <div className="bg-primary-500/5 border border-primary-500/10 p-10 rounded-[48px] flex flex-col md:flex-row items-center gap-10">
        ...
        <div>
          ...
          <p className="text-primary-200/60 leading-relaxed text-lg italic">
            "Mathematics performance has increased by 11% since the last
            intervention. The current grade distribution suggests a strong B+
            cluster. Focus on moving the top 18 students into the A category for
            the upcoming National Exams."
          </p>
        </div>
      </div>
    </div>
