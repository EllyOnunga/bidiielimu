          ...
          <div className="glass p-10 rounded-[48px] border border-white/5 space-y-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-white tracking-tight">
                    {activeRole} Privileges
                  </h3>
                  <p className="text-xs font-bold text-primary-200/40 uppercase tracking-widest mt-1">
                    Managed via Global RBAC Policy
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              {permissions.map((perm, i) => (
                <div
                  key={i}
                  className="grid grid-cols-5 items-center p-8 bg-white/[0.02] border border-white/5 rounded-[32px] group hover:bg-white/[0.04] transition-all"
                >
                  ...
                  <div className="flex justify-center">
                    <button
                      className={`p-2 rounded-lg transition-all ${perm.permissions.view ? "bg-emerald-500/10 text-emerald-400" : "bg-rose-500/10 text-rose-400"}`}
                    >
                  ...
                  <div className="flex justify-center">
                    <button
                      className={`p-2 rounded-lg transition-all ${perm.permissions.create ? "bg-emerald-500/10 text-emerald-400" : "bg-rose-500/10 text-rose-400"}`}
                    >
                  ...
                  <div className="flex justify-center">
                    <button
                      className={`p-2 rounded-lg transition-all ${perm.permissions.delete ? "bg-emerald-500/10 text-emerald-400" : "bg-rose-500/10 text-rose-400"}`}
                    >
          ...
          <div className="p-10 bg-indigo-500/5 border border-indigo-500/10 rounded-[48px] flex items-center gap-8">
            ...
            <div>
              ...
              <p className="text-primary-200/60 text-sm leading-relaxed">
                Changes to the{" "}
                <span className="text-white font-bold">{activeRole}</span> role
                will instantly affect{" "}
                <span className="text-white font-bold">48 active users</span>.
                All active sessions will be updated in real-time via the
