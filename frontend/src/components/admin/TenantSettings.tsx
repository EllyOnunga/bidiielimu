      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-primary-200/40 font-bold uppercase tracking-widest mt-1">
            Configure your school environment
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <input
                    type="text"
                    defaultValue="Greenwood Academy"
                    className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-white font-bold focus:ring-4 focus:ring-primary-500/20 outline-none"
                  />
                </div>
                <div className="space-y-3">
                  <label className="text-xs font-black text-primary-200/30 uppercase tracking-widest">
          ...
          <div className="glass p-10 rounded-[48px] border border-white/5 space-y-10">
            ...
            <div className="p-8 bg-white/5 rounded-[32px] border border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <button className="px-6 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black text-white uppercase tracking-widest hover:bg-white/10">
                Renew Early
              </button>
            </div>
          </div>
