...
export const AttendanceCorrelationChart = () => {
  ...
  if (loading)
    return (
      <div className="p-10 text-white font-bold">Correlating records...</div>
    );
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-2xl flex items-center gap-4 max-w-sm">
              ...
              <p className="text-[10px] font-bold text-emerald-200/80 leading-relaxed">
                {data.insight}
              </p>
            </div>
            <button
            ...
            <tbody className="text-white">
              {data.subject_correlations.map((row: any, i: number) => (
                ...
                >
                  ...
                  <td className="px-8 py-6 font-mono text-primary-400">
                    {row.correlation}
                  </td>
                  ...
                  <td className="px-8 py-6 text-right text-primary-200/40 font-bold">
                    {row.data_points}
                  </td>
                </tr>
              ))}
