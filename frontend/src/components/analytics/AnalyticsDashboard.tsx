...
export const AnalyticsDashboard = () => {
  ...
  if (loading)
    return (
      <div className="p-10 text-white font-bold">Analyzing cohort data...</div>
    );
    ...
    <div className="space-y-10 pb-20">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-primary-200/50 mt-2 font-medium italic">
            Predictive performance analytics & school-wide KPIs
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            ...
            value: `${data.kpis.avg_attendance}%`,
            icon: Calendar,
            color: "text-emerald-400",
          },
          {
            label: "Mean Exam Score",
            value: Math.round(data.kpis.mean_exam_score),
            icon: Award,
            color: "text-rose-400",
          },
          {
          ...
          >
            <div
              className={`w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center mb-6 ${kpi.color}`}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 glass p-10 rounded-[48px] border border-white/5">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-primary-200/40 text-sm mt-1">
                Longitudinal analysis of grade level averages
              </p>
            </div>
        ...
        <div className="glass p-10 rounded-[48px] border border-white/5">
          ...
          <p className="text-primary-200/40 text-sm mb-10 italic">
            Across current academic year
          </p>
          ...
          <div className="h-[300px]">
            ...
            >
              <PieChart>
                ...
                >
                  {["Grade A", "Grade B", "Grade C", "Grade D"].map(
                    (_, index) => (
                      <Cell
                        key={`cell-${index}`}
