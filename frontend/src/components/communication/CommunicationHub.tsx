      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {activeTab === "sms" && (
            <div className="glass p-12 rounded-[48px] border border-white/10 space-y-10 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-primary-200/40 font-medium mt-2">
                  Direct alerts to all registered parent phone numbers
                </p>
              </div>
              ...
              <div className="space-y-4 relative">
                <div className="flex justify-between items-center px-4">
                  ...
                  <span
                    className={`text-[10px] font-black uppercase tracking-widest ${smsMessage.length > 160 ? "text-rose-500" : "text-primary-200/40"}`}
                  >
              ...
              <div className="bg-primary-500/5 border border-primary-500/10 p-6 rounded-3xl flex items-start gap-4">
                ...
                <p className="text-xs text-primary-200/60 leading-relaxed italic">
                  Note: This message will be sent to approximately 450
                  guardians. Ensure information is accurate as SMS cannot be
                  unsent.
                </p>
              </div>
        ...
        <div className="space-y-8">
          <div className="glass p-8 rounded-[40px] border border-white/5 space-y-6">
            <h4 className="text-sm font-black text-white/40 uppercase tracking-widest">
              Broadcast Stats
            </h4>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <p className="text-xs font-bold text-primary-200/60">
                  Total Guardians
                </p>
              ...
              {[1, 2].map((i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-primary-200/20">
                      TOMORROW • 14:00
                    </p>
                  </div>
                </div>
