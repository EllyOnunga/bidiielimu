...
export const AssetScanner = ({ onClose }: { onClose: () => void }) => {
  ...
  const handleAction = async (action: "checkout" | "checkin") => {
    try {
      ...
      setStep("SUCCESS");
      toast.success(
        `${action === "checkout" ? "Checked out" : "Checked in"} successfully!`,
      );
    } catch (err) {
          ...
          {step === "SCAN" && (
            <div className="text-center space-y-8">
              ...
              <div>
                ...
                <p className="text-primary-200/40 mt-2 font-medium italic">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-primary-400 font-bold uppercase tracking-widest text-xs mt-1">
                    {assetDetails.status}
                  </p>
                </div>
              </div>
          ...
          {step === "SUCCESS" && (
            <div className="text-center space-y-8 py-8">
              ...
              <div>
                ...
                <p className="text-primary-200/40 mt-2 font-medium">
