...
export const ParentPortal = () => {
  ...
  if (loading)
    return (
      <div className="p-20 text-white font-black text-center animate-pulse">
      ...
      <div className="grid grid-cols-1 gap-8">
        {children.map((child) => (
          <div
            ...
            className="glass rounded-[48px] border border-white/5 overflow-hidden group"
          >
            <div className="p-10 flex flex-col md:flex-row gap-10">
              ...
              <div className="md:w-72 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-primary-200/40 uppercase tracking-widest mt-1">
                    {child.stream}
                  </p>
                  <p className="text-xs font-black text-white/20 mt-4 italic">
              ...
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-[40px] p-8 space-y-6 hover:bg-white/[0.04] transition-all cursor-pointer">
                  <div className="flex justify-between items-start">
                    ...
                    <button className="text-[10px] font-black text-emerald-400 uppercase tracking-widest bg-emerald-500/10 px-3 py-1 rounded-lg">
                      Pay Now
                    </button>
                  </div>
                  <div>
                    ...
                    <p className="text-xs font-bold text-white/20 mt-2">
                      Last Paid: KES {child.fees.paid.toLocaleString()}
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white/[0.01] border-t border-white/5 p-6 px-10 flex flex-wrap gap-4">
              {[
                ...
                <button
                  key={action}
                  className="px-6 py-2 rounded-xl bg-white/5 text-[10px] font-black text-white/40 uppercase tracking-widest hover:bg-primary-500 hover:text-white transition-all border border-white/5"
                >
                  {action}
                </button>
              ))}
