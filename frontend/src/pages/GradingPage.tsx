      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted text-xs sm:text-sm font-medium mt-2">
            Define how marks are converted to grades across your school.
          </p>
        </div>
        <Button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted mt-1">
                      {system.thresholds?.length || 0} Grade Levels
                    </p>
                  </div>
                  <Edit2
          ...
          {activeSystem ? (
              ...
              <div className="p-4 sm:p-6 border-b border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h2 className="text-lg sm:text-xl font-bold text-primary">
                    {activeSystem.name} Thresholds
                  </h2>
                  <p className="text-xs sm:text-sm text-muted mt-0.5">
                    Scores between min and max will be assigned the specified
                    grade.
                  </p>
                </div>
                <Button
                  ...
                  className="gap-2 bg-white/5 border-white/10 w-full sm:w-auto"
                >
                ...
                <Table>
                  <TableHeader className="bg-white/5">
                    <TableRow className="border-0">
                      ...
                      <TableHead className="text-right text-muted px-8">
                        Actions
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                    ...
                    {activeSystem.thresholds?.length === 0 ? (
                      ...
                      [...activeSystem.thresholds]
                        ...
                        .map((t: any) => (
                          ...
                          >
                            <TableCell className="font-black text-lg text-primary-400">
                              {t.grade}
                            </TableCell>
                            ...
                            <TableCell className="text-muted italic text-sm">
                              {t.remarks}
                            </TableCell>
            ...
            <div className="h-full min-h-[400px] glass rounded-3xl border border-white/5 border-dashed flex flex-col items-center justify-center text-center p-12">
              ...
              <p className="text-muted max-w-sm">
                Choose a grading system from the left to view and manage its
                grade thresholds.
              </p>
            </div>
          )}
