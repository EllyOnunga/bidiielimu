  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white selection:bg-primary-500/30 font-sans">
      ...
      <header className="sticky top-0 z-50 glass border-b border-white/5 h-20 px-6 flex items-center justify-between">
        ...
        <Link
          to="/login"
          className="px-6 py-2.5 bg-primary-600 hover:bg-primary-500 text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-premium transition-all"
        >
          Open App
        </Link>
      </header>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row relative">
          ...
          <nav className="space-y-2">
            {GUIDE_SECTIONS.map((section) => {
              ...
              return (
                ...
                >
                  <section.icon
                    className={`w-4 h-4 ${isActive ? "text-primary-400" : "text-slate-500 group-hover:text-white"}`}
                  />
        ...
        <main className="flex-1 p-6 md:p-12 lg:p-20">
          <motion.div
            ...
            className="max-w-3xl prose prose-invert prose-slate"
          >
            <section id="getting-started" className="mb-24 scroll-mt-32">
              ...
              <div className="bg-primary-500/10 border border-primary-500/20 p-6 rounded-2xl mb-8">
                ...
                <ul className="list-disc list-inside text-sm text-slate-300 space-y-2">
                  <li>
                    Ensure you have a modern web browser installed (Chrome,
                    Firefox, Safari).
                  </li>
                  <li>
                    You must have an Administrator or Teacher account
                    provisioned by your school.
                  </li>
            ...
            <section id="dashboard" className="mb-24 scroll-mt-32">
              ...
              <p className="text-slate-400 mb-6">
                Upon logging in, you are greeted by the Dashboard. This is your
                command center, offering real-time intelligence on your school's
                performance.
              </p>
              <div className="space-y-4 text-sm text-slate-300 mb-6">
                <div className="glass p-5 rounded-2xl border border-white/5">
                  <strong className="text-white block mb-1">Key Metrics</strong>
                  At the top, widgets display Total Students, Revenue
                  Collections, and Average Attendance for quick insights.
                </div>
                <div className="glass p-5 rounded-2xl border border-white/5">
                  <strong className="text-white block mb-1">
                    Interactive Charts
                  </strong>
                  The main chart area visualizes trends over time, such as
                  financial inflow or academic performance curves.
                </div>
              </div>
            </section>
            ...
            <section id="students" className="mb-24 scroll-mt-32">
              ...
              <p className="text-slate-400 mb-6">
                The Students module allows administrators to handle enrollment,
                class assignments, and student records efficiently.
              </p>
              <ol className="list-decimal list-inside space-y-4 text-sm text-slate-300">
                <li className="glass p-4 rounded-xl border border-white/5">
                  <strong className="text-white">Viewing Students:</strong>{" "}
                  Navigate to{" "}
                  <span className="px-2 py-0.5 bg-slate-800 rounded">
                    Students
                  </span>{" "}
                  in the sidebar to see a paginated, searchable list of all
                  enrolled students.
                </li>
                <li className="glass p-4 rounded-xl border border-white/5">
                  <strong className="text-white">Adding a Student:</strong>{" "}
                  Click the "Add Student" button. Fill in the required biodata,
                  parent contact details, and assign them to a class stream.
                </li>
                <li className="glass p-4 rounded-xl border border-white/5">
                  <strong className="text-white">Generating Reports:</strong>{" "}
                  Click on any student's profile to view their comprehensive
                  Report Card, combining attendance and exam metrics.
                </li>
              </ol>
            </section>
            ...
            <section id="fees" className="mb-24 scroll-mt-32">
              ...
              <p className="text-slate-400 mb-6">
                Control your institution's capital flow seamlessly. Track
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
                  ...
                  <p className="text-slate-400">
                    Define fee structures for specific terms and classes. Assign
                    items like Tuition, Transport, and Boarding.
                  </p>
                </div>
                <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
                  <h4 className="text-white font-bold mb-2">
                  ...
                  <p className="text-slate-400">
                    Navigate to a student's finance tab to log a payment. The
                    system automatically calculates remaining balances.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="exams" className="mb-24 scroll-mt-32">
              ...
              <ul className="list-disc list-inside space-y-4 text-sm text-slate-300">
                <li>
                  <strong className="text-white">Setup:</strong> Create an Exam
                  (e.g., "Mid-Term 1") and assign subjects.
                </li>
                <li>
                  <strong className="text-white">Marks Entry:</strong> Teachers
                  navigate to the{" "}
                  <span className="px-2 py-0.5 bg-slate-800 rounded">
                    Marks Entry
                  </span>{" "}
                  page, select their class and subject, and input scores
                  directly into a spreadsheet-like interface.
                </li>
                <li>
                  <strong className="text-white">Analysis:</strong> Once marks
                  are entered, the system instantly computes grades, class
                  ranks, and subject averages.
                </li>
              </ul>
            </section>
            ...
            <section id="attendance" className="mb-24 scroll-mt-32">
              ...
              <p className="text-slate-400 mb-6">
                Active presence intelligence allows you to mark and track
                student attendance daily.
              </p>
              <p className="text-sm text-slate-300 glass p-5 rounded-2xl border border-white/5">
                Go to <strong className="text-white">Attendance</strong>. Select
                the Date and Class. A list of students will appear. Toggle their
                status between Present, Absent, or Late. Save the register to
                immediately update their metrics.
              </p>
            </section>
            ...
            <section id="timetable" className="mb-24 scroll-mt-32">
              ...
              <p className="text-sm text-slate-300 mb-6">
                The Timetable module displays a grid view of the week.
                Administrators can drag and drop subjects and assign teachers to
                specific time slots. The system automatically warns you if a
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 p-5 rounded-xl flex items-start gap-4">
                ...
                <p className="text-xs text-blue-200/80 leading-relaxed">
                  Students and Parents can view their specific class timetable
                  securely from their portals once it's published by the
                  administration.
                </p>
              </div>
            </section>
