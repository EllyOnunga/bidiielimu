    ...
    <div className="max-w-5xl mx-auto px-4 pt-28 pb-20">
      ...
      >
        ...
        <h1 className="text-5xl font-black mb-4">
          Join the Team Transforming <br />
          Education in Africa
        </h1>
        <p className="text-slate-400 max-w-2xl mx-auto text-lg">
          We're building for impact. If you're passionate about education,
          technology, and Africa — come build with us.
        </p>
      </motion.div>
      ...
      <div className="glass-dark rounded-[32px] border border-white/5 p-10 text-center">
        ...
        <p className="text-slate-400 text-sm mb-6 max-w-md mx-auto">
          We're always interested in exceptional people. Send us an open
          application.
        </p>
        <Link
          to="/#contact"
          className="inline-flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-500 text-white rounded-xl font-bold transition-all"
        >
