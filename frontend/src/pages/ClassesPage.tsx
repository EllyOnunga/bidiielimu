      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-muted text-xs sm:text-sm md:text-base font-medium max-w-xl">
            Engineer your school's structural hierarchy from grades to
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          ...
          <Button
            ...
            className="gap-2 w-full md:w-auto h-14 px-8 rounded-2xl font-black uppercase tracking-widest text-xs shadow-premium shrink-0"
          >
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 gap-8">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="glass rounded-[40px] border-white/5 p-8 space-y-6"
            >
        ...
        <div className="glass rounded-[40px] border-white/5 p-12 md:p-24 text-center">
          ...
          <p className="text-muted text-xs sm:text-sm font-medium mb-10 max-w-md mx-auto">
            Establish your school's foundation by defining the primary grade
            levels and their operational streams.
          </p>
          <Button
            onClick={() => setShowGradeModal(true)}
            className="h-12 md:h-14 px-10 rounded-2xl font-black uppercase tracking-widest text-xs shadow-premium"
          >
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 sm:p-8 gap-4 sm:gap-6 border-b border-white/5 bg-white/[0.02]">
                <div className="flex items-center gap-4 sm:gap-6">
                  ...
                  <div>
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-primary uppercase tracking-tight">
                      {grade.name}
                    </h2>
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1.5">
                      <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/5 border border-white/5">
                        ...
                        <span className="text-[10px] font-black text-primary uppercase tracking-widest">
                          {grade.student_count} Enrolled
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/5 border border-white/5">
                        <Users className="w-3.5 h-3.5 text-accent-400" />
                        <span className="text-[10px] font-black text-primary uppercase tracking-widest">
                          {grade.streams.length} Operations
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-4 sm:p-8">
                {grade.streams.length === 0 ? (
                  <div className="text-center py-8 sm:py-12 border-2 border-dashed border-white/5 rounded-[32px]">
                    <p className="text-xs font-black text-primary-200/20 uppercase tracking-[0.3em]">
                      No Active Streams Defined
                    </p>
                  </div>
                ) : (
                    ...
                    {grade.streams.map((stream: any) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-sm sm:text-base font-black text-primary uppercase tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-muted text-[10px] font-black uppercase tracking-[0.2em] mt-1">
              Manage the core curriculum infrastructure.
            </p>
          </div>
          <Button
            onClick={() => setShowSubjectModal(true)}
            variant="outline"
            className="gap-2 h-12 px-6 bg-primary-500/5 border-primary-500/20 text-primary-400 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-primary-500/10 transition-all"
          >
        ...
        {subjects.length === 0 ? (
          <div className="p-16 text-center glass rounded-[40px] border border-dashed border-white/5 opacity-30">
            ...
            <p className="text-sm font-black uppercase tracking-widest">
              No Intelligence Domains Established
            </p>
          </div>
        ) : (
      ...
      >
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-muted uppercase tracking-widest">
                Commanding Officer (Class Teacher)
              </label>
              <select
