      ...
      <div className="glass-dark rounded-[32px] border border-white/5 p-8 md:p-12">
        ...
        <Section title="2. How We Use Cookies">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              ...
              Required for authentication and session management (e.g., JWT
              tokens stored in memory).
            </li>
            <li>
              <strong className="text-white">Preference Cookies:</strong>{" "}
              Remember your theme (dark/light) and sidebar state.
            </li>
            <li>
              <strong className="text-white">Analytics Cookies:</strong> Help us
              understand how features are used (anonymized, no personal data).
            </li>
          </ul>
        </Section>
        <Section title="3. We Do NOT Use">
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Cookies that contain student PII (personally identifiable
              information)
            </li>
          </ul>
        </Section>
        <Section title="4. Managing Cookies">
          <p>
            ...
            essential cookies may impair your ability to log in and use the
            platform.
          </p>
        </Section>
        <Section title="5. Changes to This Policy">
          <p>
            ...
            reflected with an updated date above.
          </p>
        </Section>
