        ...
        <div className="glass h-20 px-8 flex items-center justify-between rounded-[28px]">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <span className="text-2xl font-black tracking-tighter uppercase font-serif">
              Elimu<span className="text-teal-400">Hub</span>
            </span>
          </Link>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-primary-200/50 mb-4 font-medium leading-relaxed max-w-xl">
              ElimuHub is a comprehensive multi-tenant SaaS platform built on Django + Vite + React — engineered to outperform global standards in African and global markets.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5">
              <Link to="/register" className="w-full sm:w-auto px-10 py-5 bg-teal-600 hover:bg-teal-500 text-white rounded-[24px] font-black uppercase tracking-widest text-xs shadow-premium active:scale-[0.98] transition-all flex items-center justify-center gap-3">
                Experience ElimuHub <ArrowRight className="w-5 h-5" />
              </Link>
          ...
          >
            ...
            <div className="glass p-3 rounded-[48px] shadow-glass relative overflow-hidden group">
              ...
              <div className="transform group-hover:scale-[1.02] transition-transform duration-1000 relative z-10">
                <img src="/dashboard-hero.png" alt="ElimuHub Dashboard" className="w-full h-auto rounded-[36px] object-cover" />
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto glass rounded-[60px] overflow-hidden grid lg:grid-cols-2 shadow-glass relative">
          <div className="p-12 md:p-20 bg-primary-600 relative overflow-hidden">
            ...
            <div className="space-y-10 relative z-10">
              {[
                { icon: Mail, label: 'Transmission', value: 'intel@elimuhub.app' },
      ...
      <footer className="pt-20 pb-16 px-6">
        <div className="max-w-7xl mx-auto border-t border-white/5 pt-20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 text-center md:text-left">
            <div className="space-y-4">
              <div className="flex items-center gap-3 justify-center md:justify-start">
                ...
                <span className="text-2xl font-black tracking-tighter uppercase font-serif">Elimu<span className="text-teal-400">Hub</span></span>
              </div>
          ...
          <div className="mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-[10px] font-black text-primary-200/20 uppercase tracking-[0.3em]">
            <p>&copy; {new Date().getFullYear()} ELIMUHUB SYSTEM PROTOCOL. ALL RIGHTS RESERVED.</p>
