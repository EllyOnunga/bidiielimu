  ...
  const handleBulkUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errs && errs.length > 0) {
        ...
        toast.error(
          error.response?.data?.detail || "Failed to bulk upload students",
        );
      }
    } finally {
    ...
    >
      ...
      <div className="premium-card !p-0 overflow-hidden relative">
          ...
          >
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Button
                size="sm"
                variant="outline"
                className="flex-1 sm:flex-none bg-white/10 border-white/10 text-white text-[9px] h-9"
              >
                Archive
              </Button>
              <Button
        ...
        <div className="p-4 md:p-6 border-b border-white/5 flex flex-col md:flex-row gap-4 items-center justify-between bg-white/[0.02]">
          ...
          <Button
            variant="outline"
            size="sm"
            className="w-full md:w-auto gap-2 text-[10px]"
          >
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={8} className="text-center py-20 md:py-24">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-lg md:text-xl font-black text-primary tracking-tight mb-2 uppercase">
                      No Records Found
                    </h3>
                    <p className="text-muted font-medium text-[10px] sm:text-xs max-w-sm mx-auto mb-8 leading-relaxed px-4">
                      Your search did not return any assets. Try different query
                      parameters or initialize a new record.
                    </p>
                    {search && (
                      <Button
                        variant="outline"
              ...
              studentsData.map((student: Student, idx: number) => (
                ...
                >
                  ...
                  <TableCell className="font-black text-primary-400 font-mono text-[10px] sm:text-xs">
                    {student.admission_number}
                  </TableCell>
                  <TableCell>
                    <div className="text-[10px] sm:text-xs font-black text-primary uppercase tracking-tight truncate max-w-[100px] sm:max-w-none">
                  ...
                  <TableCell>
                    {student.grade_name ? (
                      ...
                      <span className="text-dim text-[9px] font-black uppercase tracking-widest italic">
                        Unallocated
                      </span>
                    )}
                  </TableCell>
      ...
      >
        <form
          ...
          className="space-y-6 sm:space-y-8 mt-6 pb-2"
        >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-xl border border-white/5 bg-white/5 px-4 text-xs text-white outline-none focus:border-primary-500/50 transition-all"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Input
                  ...
                  type="password"
                  placeholder={
                    editingStudent ? "Reset Password?" : "Encryption Key"
                  }
      ...
      >
        <div className="mt-6 space-y-6">
          ...
          >
            ...
            />
            <UploadCloud
              className={`w-12 h-12 mx-auto mb-4 ${csvFile ? "text-primary-400" : "text-primary-200/10"}`}
            />
            {csvFile ? (
              <div>
                <p className="text-white font-black uppercase text-xs mb-1">
                  {csvFile.name}
                </p>
                <p className="text-[9px] font-bold text-primary-200/30 uppercase">
              ...
              <div>
                ...
                <p className="text-[9px] font-bold text-primary-200/20 uppercase tracking-widest">
                  CSV Format Required
                </p>
              </div>
            )}
