      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-4">
            ElimuHub was born in 2022 out of frustration. Our founders — former teachers and school administrators — spent years watching schools struggle with paper registers, Excel fee sheets, and WhatsApp grade reports.
          </p>
          <p className="text-slate-400 text-lg leading-relaxed">
            We built ElimuHub SYSTEM to fix that. A single, beautiful, reliable platform that every school in Africa can afford and use from day one.
          </p>
        </div>
