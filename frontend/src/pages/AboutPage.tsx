      ...
      >
          ...
          {[
            {
              icon: Target,
              title: "Our Mission",
              desc: "To give every school — no matter its size or budget — access to world-class management tools.",
            },
            {
              icon: Heart,
              title: "Our Values",
              desc: "Simplicity, reliability, and genuine care for educators and the children they serve.",
            },
            {
              icon: GraduationCap,
              title: "Our Impact",
              desc: "Over 50 schools, 10,000+ students, and hundreds of teachers empowered and counting.",
            },
          ].map((item) => (
            <div
              key={item.title}
        ...
        <div className="glass-dark rounded-[40px] border border-white/5 p-12 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-xl mx-auto">
            We're always looking for passionate people who want to transform
            education in Africa.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/careers"
              className="px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-bold transition-all flex items-center justify-center gap-2"
            >
