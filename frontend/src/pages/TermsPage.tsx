    ...
    <div className="max-w-3xl mx-auto px-4 pt-28 pb-20">
      ...
      <div className="glass-dark rounded-[32px] border border-white/5 p-8 md:p-12">
        ...
        <Section title="2. Use of the Service">
          ...
          <p>
            Each school account (tenant) is solely responsible for the data
            entered and the accuracy of that data.
          </p>
        </Section>
        <Section title="3. Account Registration">
          <p>
            To use the Service, a school administrator must register and provide
        ...
        <Section title="5. Service Availability">
          <p>
            ...
            Scheduled maintenance windows will be communicated in advance where
            possible.
          </p>
        </Section>
        <Section title="6. Termination">
          <p>
            ...
            notice. Upon termination, you may request a data export before
            account deletion.
          </p>
        </Section>
