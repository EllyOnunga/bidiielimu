    ...
    <div className="max-w-3xl mx-auto px-4 pt-28 pb-20">
      ...
      <div className="glass-dark rounded-[32px] border border-white/5 p-8 md:p-12">
        <Section title="1. Acceptance of Terms">
          <p>By accessing or using ElimuHub SYSTEM ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, please discontinue use immediately.</p>
        </Section>
        <Section title="2. Use of the Service">
          <p>ElimuHub SYSTEM is licensed to educational institutions for academic management purposes. You may not use the Service for any unlawful purpose or in violation of any regulations.</p>
        ...
        <Section title="4. Data Ownership">
          <p>All data entered into the system by your institution remains your property. ElimuHub does not claim ownership of school or student data. You grant us a limited license to process that data solely to deliver the Service.</p>
        </Section>
        ...
        <Section title="7. Limitation of Liability">
          <p>ElimuHub shall not be liable for indirect, incidental, or consequential damages arising from your use of or inability to use the Service.</p>
        </Section>
        ...
        <Section title="9. Contact">
          <p>For questions about these terms, contact us at <a href="mailto:support@elimuhub.app" className="text-primary-400 hover:underline">support@elimuhub.app</a>.</p>
        </Section>
      </div>
