  ...
  <div className="premium-card group hover:bg-white/[0.03]">
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
      ...
      <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-2 sm:p-2.5 bg-primary-500/10 hover:bg-primary-600 hover:text-white text-primary-400 rounded-xl transition-all"
              ...
              <Link
                ...
                className="p-2 sm:p-2.5 bg-white/5 hover:bg-white/20 text-white rounded-xl transition-all"
              >
              ...
              <button
                ...
                className="p-2 sm:p-2.5 bg-rose-500/10 hover:bg-rose-600 hover:text-white text-rose-400 rounded-xl transition-all"
              >
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-[10px] font-black text-dim uppercase tracking-widest">
