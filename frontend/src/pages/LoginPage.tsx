...
export const LoginPage = () => {
  ...
  const handleOTPVerify = async (e: React.FormEvent) => {
    ...
    try {
      const { access, refresh, user } = await authService.verifyOTP(
        userId,
        otp,
      );
      setAuth(user, access, refresh);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent relative overflow-hidden px-4 py-8 md:py-12">
      ...
      >
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 transition-colors mb-6 sm:mb-8 text-sm font-semibold group"
        >
        ...
        <div className="glass p-6 sm:p-10 md:p-12 rounded-[32px] sm:rounded-[40px]">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-primary tracking-tight mb-2 sm:mb-3">
              Welcome Back
            </h1>
            ...
            {!isOTPStep ? (
              ...
              >
                ...
                <div className="relative my-6 sm:my-8">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-bg-color px-4 text-muted font-bold tracking-widest">
                      Or
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="pt-4 border-t border-white/5">
                  <p className="text-[10px] text-muted font-bold uppercase tracking-wider mb-3 text-center">
                    Resend Code
                  </p>
