  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-primary tracking-tight mb-2">
            Revenue <span className="text-gradient">Engine</span>
          </h1>
          <p className="text-muted text-xs sm:text-sm md:text-base font-medium">
            Monitor financial health and manage secure transaction protocols.
          </p>
        </div>
        <Button
          onClick={() => setShowPaymentModal(true)}
          className="gap-2 h-14 px-8 rounded-2xl font-black uppercase tracking-widest text-xs shadow-premium w-full sm:w-auto"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="glass p-5 sm:p-6 md:p-8 rounded-[28px] sm:rounded-[40px] border-white/5 relative overflow-hidden group">
          ...
          <p className="text-[10px] font-black text-muted uppercase tracking-[0.2em] mb-3 sm:mb-4">
            Gross Collected
          </p>
          <div className="flex items-end justify-between">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-primary tracking-tight">
        ...
        <div className="glass p-5 sm:p-6 md:p-8 rounded-[28px] sm:rounded-[40px] border-white/5 relative overflow-hidden group">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-rose-400 tracking-tight">
        ...
        <div className="glass p-5 sm:p-6 md:p-8 rounded-[28px] sm:rounded-[40px] border-white/5 relative overflow-hidden group sm:col-span-2 lg:col-span-1">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-primary-400 tracking-tight">
              {completionRate}%
            </h3>
      ...
      <div className="glass rounded-[40px] border-white/5 overflow-hidden">
        <div className="p-6 md:p-8 border-b border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <h2 className="text-lg md:text-xl font-black text-primary uppercase tracking-widest">
            Transaction Journal
          </h2>
          ...
          <Table className="min-w-[1000px]">
            <TableHeader className="bg-white/5">
              <TableRow className="border-0 hover:bg-transparent h-16">
                <TableHead className="text-primary-200/40 text-[10px] font-black uppercase tracking-widest pl-8">
                  Operational Unit
                </TableHead>
                <TableHead className="text-primary-200/40 text-[10px] font-black uppercase tracking-widest">
                  Protocol Reference
                </TableHead>
                <TableHead className="text-primary-200/40 text-[10px] font-black uppercase tracking-widest">
                  Quantum (Amount)
                ...
                <TableHead className="text-primary-200/40 text-[10px] font-black uppercase tracking-widest pr-8">
                  Timestamp
                </TableHead>
              </TableRow>
            </TableHeader>
              ...
              {paymentsLoading ? (
                ...
                paymentsData.map((payment: Payment, idx: number) => (
                  ...
                  >
                    ...
                    <TableCell className="font-mono text-[9px] sm:text-[10px] text-muted uppercase tracking-widest">
                      {payment.transaction_reference}
                    </TableCell>
                    <TableCell className="font-black text-sm sm:text-base text-primary tracking-tight">
                    ...
                    <TableCell className="text-[10px] font-black text-primary-200/30 uppercase tracking-widest pr-8">
        ...
        <div className="space-y-8 mt-6 pb-4">
          <div className="flex items-center gap-6 p-6 bg-primary-600 rounded-[32px] shadow-premium">
            ...
            <div>
              ...
              <p className="text-primary-100 text-[10px] font-black uppercase tracking-[0.2em] mt-1">
                Automated M-Pesa STK Push Protocol
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handlePayment} className="space-y-8">
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-muted uppercase tracking-widest pl-1">
                  Target Operational Unit (Student)
                </label>
                <select
                  required
                ...
                >
                  ...
                  {balances.map((b: StudentBalance) => (
                    ...
                    >
                      {b.name} ({b.admission_number}) • Bal: KSh{" "}
            ...
            <div className="p-6 bg-primary-500/5 border border-primary-500/10 rounded-[28px] flex gap-4">
              ...
              <p className="text-[10px] font-black text-primary-300 uppercase tracking-widest leading-relaxed">
                ...
                terminal. User authorization (PIN) is required to finalize the
                transaction.
              </p>
            </div>
