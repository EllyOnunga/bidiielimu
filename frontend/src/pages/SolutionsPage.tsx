...
const solutions = [
  ...
  },
  {
    ...
    features: [
      "TSC compliance reports",
      "MOE enrollment returns",
      "Audit log exports",
      "Multi-role access",
    ],
    ...
    <div className="max-w-7xl mx-auto px-4 pt-28 pb-20">
        ...
        {solutions.map((sol, i) => (
          ...
          >
            ...
            <div className="p-8">
              ...
              <Link
                to="/register"
                className="flex items-center gap-2 text-primary-400 font-bold text-sm hover:text-primary-300 transition-colors group-hover:gap-3"
              >
      ...
      <div className="mt-24 glass-dark rounded-[40px] border border-white/5 p-12 text-center">
        ...
        <p className="text-slate-400 mb-8 max-w-xl mx-auto">
          Our team will analyze your school's needs and recommend the right
          configuration — free of charge.
        </p>
        <Link
          to="/#contact"
          className="inline-flex items-center gap-2 px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-bold transition-all shadow-lg"
        >
